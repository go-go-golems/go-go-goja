...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js": function(exports2, module2) {
    !(function(t, e) {
...
var require_lodash = __commonJS({
  "node_modules/lodash/lodash.js": function(exports2, module2) {
    (function() {
      var undefined;
      var VERSION = "4.17.21";
...
// src/assets/logo.svg
var logo_default = '<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64">\n  <rect width="64" height="64" fill="#1f6feb" />\n  <circle cx="32" cy="32" r="18" fill="#f0f6fc" />\n</svg>\n';

// src/main.ts
var exec = __toESM(require("exec"));
var fs = __toESM(require("fs"));
function run2() {
  var items = [{ n: 2 }, { n: 3 }];
  var total = lodash.sumBy(items, "n");
  var stamp = (0, import_dayjs.default)().format("YYYY-MM-DD");
  var logoChars = logo_default.split("");
  var counts = lodash.countBy(logoChars, function(ch) {
    return ch;
  });
  ...
  var checksum = lodash.reduce(
    logoChars,
    function(acc, ch) {
      return (acc + ch.charCodeAt(0)) % 1e5;
    },
    0
  );
  var payload = "date=" + stamp + " sum=" + total + " svgLen=" + logo_default.length + " svgTags=" + tagCount + " svgCsum=" + checksum;
