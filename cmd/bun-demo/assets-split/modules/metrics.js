...
function buildMetrics() {
  var codepoints = import_lodash.default.map(logo_default.split(""), function(ch) {
    return ch.charCodeAt(0);
  });
  var svgCsum = import_lodash.default.sum(codepoints);
  var svgTags = countTags(logo_default);
  return [
    "svgLen=" + logo_default.length,
    "svgTags=" + svgTags,
    "svgCsum=" + svgCsum
  ].join(" ");
}
