...
- [ ] Implement XGOJA-TS-002 embedded/provider TypeScript runtime bundling fix.
- [ ] Create follow-up implementation ticket for xgoja v2 spec DTOs and migrate-spec tooling.
- [ ] Create follow-up implementation ticket for Go workspace resolution.
- [ ] Create follow-up implementation ticket for pkg/xgoja/sourcegraph.
- [ ] Create follow-up implementation ticket for provider graph and centralized runtime module alias resolution.
- [ ] Add future xgoja plan/graph debug commands after planning APIs exist.
