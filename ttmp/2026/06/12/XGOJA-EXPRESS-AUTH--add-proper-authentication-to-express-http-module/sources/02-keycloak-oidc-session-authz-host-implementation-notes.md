---
Title: Keycloak OIDC session authorization host implementation notes
...
ExternalSources:
    - /tmp/auth2.md
Summary: Imported implementation guidance for using Keycloak/OIDC, server-side sessions, application-owned authorization, capabilities, and audit in a robust Go host.
LastUpdated: 2026-06-12T16:45:00-04:00
WhatFor: Source material for designing a robust host-side auth implementation behind gojahttp planned routes.
WhenToUse: Read when implementing login/logout, sessions, Keycloak/OIDC integration, user normalization, authorization, capabilities, and audit for Express planned auth hosts.
---
