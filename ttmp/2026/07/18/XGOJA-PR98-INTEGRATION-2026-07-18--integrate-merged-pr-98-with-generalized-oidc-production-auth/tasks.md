...
- [x] Inventory merged PR 98 and current generalized OIDC branch <!-- t:iqn3 -->
- [x] Write intern-facing analysis design and implementation guide <!-- t:j0bt -->
- [x] Resolve application identity and SQL persistence conflicts <!-- t:aqu9 -->
- [x] Port durable OIDC transactions and observability into oidcauth <!-- t:dys5 -->
